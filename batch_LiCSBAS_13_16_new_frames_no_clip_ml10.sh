...
### Settings ####
#################
start_step="13"	# 01-05, 11-16
end_step="16"	# 01-05, 11-16

cometdev='0'
nlook="10"	# multilook factor, used in step02
GEOCmldir=GEOCml10GACOSmask	# If start from 11 or later after doing 03-05, use e.g., GEOCml${nlook}GACOSmaskclip
n_para="10" # Number of paralell processing in step 02-05,12,13,16. default: number of usable CPU
gpu="n"	# y/n
...
p01_start_date="20141001"	# default: 20141001
p01_end_date="20221231"	# default: today
p01_get_gacos="y" # y/n 
p11_unw_thre="0.6"	# default: 0.3
p11_coh_thre="0.05"	# default: 0.05
p12_loop_thre="1.5"	# default: 1.5 rad
...
p15_n_unw_r_thre="0.5"	# default: 1.5
p15_vstd_thre="10"	# default: 100 mm/yr
p15_maxTlen_thre="0"	# default: 1 yr
p15_n_gap_thre="5"	# default: 10
p15_stc_thre="15"	# default: 5 mm
p15_n_ifg_noloop_thre="250"	# default: 50
p15_n_loop_err_thre="15"	# default: 5
...
p12_n_para="10"	# default: # of usable CPU
...
p13_n_para="10"	# default: # of usable CPU
...
p16_n_para="10"   # default: # of usable CPU
